...
const EducationEva = () => {
  ...
  const steps = [
    {
      ...
      description: "Arizona International Credential Evaluators (AZICE) provides trusted evaluation services for immigration, employment, and education.",
      icon: UserPlus,
      color: "emerald",
      content: (
        <div className="flex flex-col sm:flex-row gap-3 mt-6">
          <a
            ...
            className="flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-6 py-3.5 rounded-xl font-semibold hover:from-emerald-600 hover:to-emerald-700 transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] text-sm sm:text-base w-full"
          >
    ...
    },
    {
      ...
      description: "Gather the following documents for your Arizona International evaluation.",
      icon: FileText,
      color: "blue",
      content: (
        <div className="space-y-3 mt-5">
          {[
            ...
            { label: "AZ Cred Eval reference number (if available)", isText: true },
          ].map((item, index) => (
            <motion.div
              key={index}
  ...
  const features = [
    ...
    },
    {
      icon: Shield,
      title: "Secure & Safe",
      description: "Trusted document handling",
      color: "blue"
    },
    {
      icon: Award,
      title: "AZICE Recognized",
      description: "Official evaluation service",
      color: "amber"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white pt-16 md:pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Arizona International Evaluation
          </motion.h1>
          ...
          >
            Arizona International Credential Evaluators – Step by Step Guide
          </motion.p>
          ...
          >
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-xl border border-gray-200 p-6 sm:p-8 overflow-hidden">
              ...
              >
                <img
                  src={workflowImg}
                  alt="AZICE - 100 Transcripts Workflow"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-bold text-gray-900 text-sm sm:text-base">AZICE Trusted</p>
                  </div>
                </motion.div>
              </div>
            </div>
            ...
            >
              <h3 className="text-xl sm:text-2xl font-bold mb-2">Need Guidance?</h3>
              <p className="text-blue-100 text-sm sm:text-base mb-6">Our experts are here to help you with your AZICE application.</p>
              <a
